...
public class _03_String02 {
    public static void main(String[] args) {
        ...
        System.out.println(str4.replaceAll("[ac]",""));//[]안의 문자를 전부 치환한다.
        System.out.println(str4.replace('a', '1').replace('b','2').replace('c','3'));
    }
}

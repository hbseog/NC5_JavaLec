...
public class _01_arrayList {
    public static void main(String[] args) {
        ...
        //print()의 매개변수로 객체를 넣게 되면 자동으로 toString()메소드가 실행된 결과가 출력된다.
        ...
        else System.out.println("list1이 list2를 포함하지 않습니다.");
        System.out.println("--------------------------------");
        ...
        ArrayList list4 = new ArrayList();//=>크기 10
        list4.add(10);
        ...
        //Type를 지정 안 했을 때의 문제점
        //형 변환시 castException이 발생할 수 있다.
